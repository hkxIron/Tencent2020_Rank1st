...
class BertModel(nn.Module):
    def __init__(self, bert_encoder, config, args):
        ...
        for vocab_size in args.vocab_size:
            ...
            self.lm_head_layer_list.append(nn.Linear(in_features=config.hidden_size, out_features=vocab_size, bias=False))
    ...
    def forward(self, inputs, inputs_ids, masks, labels):
        ...
        for idx,(feature_output_head_layer, vec_id_dim_istrain) in enumerate(zip(self.lm_head_layer_list, self.args.text_features)):
